...
namespace radar
{
	namespace radar_2d
	{
		...
		{
			public class Test_radar_box_hits_no_distance
			{
				...
				public IEnumerator should_no_find_no_one()
				{
					...
					no_finded_one.transform.position = new Vector3( 3, 0 );
					no_finded_two.transform.position = new Vector3( 6, 0 );
					yield return null;
				...
				public IEnumerator should_find_all_elements()
				{
					...
					finded_one.transform.position = new Vector3( 1, 1 );
					finded_two.transform.position = new Vector3( 1, -1 );
					yield return null;
