...
public class Test_ai_walk_when_intanciate
{
	...
	[UnityTest]
	public IEnumerator if_the_desire_position_is_to_left_should_walk_to_left_direction()
	{
	...
	[UnityTest]
	public IEnumerator if_the_desire_position_is_to_right_should_walk_to_right_direction()
	{
		Ai_walk ai = player.transform.GetComponent<Ai_walk>();
		Vector3 initial_position = player.transform.position;
